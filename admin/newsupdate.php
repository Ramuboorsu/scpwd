...
$imgcontent = $_POST['imgcontent'];
  ...
  $up = mysqli_query($con,"update newsevents set mainHeading='$mainheading',description='$description',imgcontent='$imgcontent' where aid='$id'");

 if(mysqli_affected_rows($con) > 0)
{
    echo '<script>window.location.href="newsEvents.php";</script>';
...
<center>
    ...
    <br>
    <input type="text" placeholder="UserName" value="<?php echo $mainheading; ?>" name="mainheading" required pattern="^[a-zA-Z0-9\s]{3,60000}" title="please Enter min 3 and max 15 letters">
    <br>
...
<br>
     <label for="ROLE"><b>ImageContent</b></label><br>
    <textarea id="w3review" name="imgcontent" rows="14" cols="50"><?php echo $imgcontent; ?></textarea>
    <hr>
