...
<li  class="<?php if(($page=="about") || ($page=="")) { echo "active"; } ?> "><a href="adminhome.php">HOME</a></li>
<li  class="<?php if(($page=="about") || ($page=="")) { echo "active"; } ?> "><a href="adminindex.php">UPDATEINDEX</a></li>
         <li  class="<?php if(($page=="about") || ($page=="")) { echo "active"; } ?> "><a href="headerupdate2.php">UPDATEHEADER</a></li>
        ...
        <li  class="<?php if(($page=="gallery") || ($page=="")) { echo "active"; } ?> "><a href="imgupload.php">GALLERY</a></li>
         <li  class="<?php if(($page=="contactus") || ($page=="")) { echo "active"; } ?> "><a href="contactus.php">ContactUs</a></li>
        <!--li class=""><a href="activities.php">ACTIVITIES</a></li-->
        <li  class="<?php if(($page=="contact") || ($page=="")) { echo "active"; } ?> "><a href="#">WHO's WHO</a></li>
        <!-- <li  class="<?php if(($page=="contact") || ($page=="")) { echo "active"; } ?> "><a href="headerupdate.php">HeaderUPDATE</a></li> -->
