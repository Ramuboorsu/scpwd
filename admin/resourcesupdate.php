...
$description =  mysql_real_escape_string($_POST['description']);
  ...
  $up = mysqli_query($con,"update resources_text set heading='$heading',description='$description' where id='$id'");
...
<center>
    ...
    <br>
    <input type="text" placeholder="UserName" value="<?php echo $heading; ?>" name="heading"  title="please Enter min 3 and max 15 letters">
    <br>
