...
$description = $_POST['description'];
  ...
  $up = mysqli_query($con,"update indexupdate set heading='$heading',description='$description' where id='$id'");
...
<?php
$id = @$_GET['id'];
$sel = mysqli_query($con,"select * from indexupdate where id =$id");
...
<center>
    ...
    <label for="psw-repeat"><b>heading</b></label>
    <br>
    <input type="text" placeholder="UserName" value="<?php echo $heading; ?>" name="heading" required pattern="^[a-zA-Z0-9\s]{3,60000}" title="please Enter min 3 and max 15 letters">
    <br>
    ...
    <input type="submit" formaction="adminindex.php" class="cancelbtn"  name="cancel" value="Cancel">
    </center>
  </div>
  <?php
}
