...
<section>
      <div class="container pt-20 pb-20">
        ...
        <div class="row col-md-8">
             ...
             <?php 
             $sel = "select *from gallerytable";
             $res = mysqli_query($con,$sel);
             while($tot = mysqli_fetch_assoc($res)){
?>
              <!-- Portfolio Item Start -->
              <div class="gallery-item">
                <a href="images/gallery/<?php echo $tot['image_name'];?>" data-lightbox="gallery-item" title="Title Here 1"><img src="images/gallery/<?php echo $tot['image_name'];?>" alt=""></a>
              </div>
              <!-- Portfolio Item End -->        
<?php    
} 
