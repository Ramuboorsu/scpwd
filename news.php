...
<?php
$sel = mysqli_query($con,"select * from newsEvents where aid=1");
while($fet = mysqli_fetch_assoc($sel))
{
  ?>

            <h3 class="text-uppercasetext-theme-colored mt-0 mb-0 mt-sm-30" style="text-decoration: underline; font-size:18px;"><?php echo $fet['mainHeading'];?></span></h3>
                            
             <h4 style="font-weight: 500; line-height: 30px; font-size:16px;"><?php echo $fet['description'];?>
</h4>
             
              </div>
             <div class="col-md-12">
                    <img src="images/news/<?php echo $fet['image'];?>">
                </div>
            <div class="col-md-12">
            <h4 style="font-weight: 500; line-height: 30px; font-size:16px;"><?php echo $fet['imgcontent'];?></h4>
</div>
  <?php
  }
  ?>     
           ...
           <?php
$sel = mysqli_query($con,"select * from newsEvents where aid=2");
while($fet = mysqli_fetch_assoc($sel))
{
  ?>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <img src="images/news/<?php echo $fet['image2'];?>">
                </div>
         ...
         <?php } ?>      
             ...
             <?php
$sel = mysqli_query($con,"select * from newsEvents where aid=3");
while($fet = mysqli_fetch_assoc($sel))
{
  ?>   
            <h3 class="text-uppercasetext-theme-colored mt-0 mb-0 mt-sm-30" style="text-decoration: underline; font-size:18px;"><?php echo $fet['mainHeading'];?></span></h3>
       ...
       <?php
$sel = mysqli_query($con,"select * from newsEvents where aid=4");
while($fet = mysqli_fetch_assoc($sel))
{
       ?>       
              <h3 class="text-uppercasetext-theme-colored mt-0 mb-0 mt-sm-30" style=" font-size:18px;"><?php echo $fet['mainHeading'];?>
</span></h3>
