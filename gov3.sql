...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 17, 2020 at 06:39 PM
...
(4, 'Achievements', 'Coming Soonghfhfg', 'Achivements are got govt certificate');
...
(25, 'img4.jpeg', '../images/gallery/img4.jpeg'),
(26, 'img4.jpeg', '../images/gallery/img4.jpeg');
...
(1, 'minister.jpg', 'Shri Koppula Eshwar Garu  Minister for SCD,BC,Minority,Disabled&Senior citizen welfare, Telangana state', 'logo.png', 'emblem.png', 'Office of the State Commissioner For Persons with Disabilities ', 'ada.png', 'Government of TS', 'minister.jpg', 'Shri Koppula Eshwar Garu  Minister for SCD,BC,Minority,Disabled&Senior citizen welfare, Telangana state');
...
CREATE TABLE `indexupdate` (
  ...
  `read_more` varchar(2000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `indexupdate`
--

INSERT INTO `indexupdate` (`id`, `heading`, `description`, `read_more`) VALUES
(1, 'Accessibility statement of government', 'The Official website of the State Commissioner for Persons with Disabilities(SCPD), Telangana has been built with an objective of providing maximum accessibility and usability by its visitors.This website can be viewed from a selection of devices such as Desktop / Laptop computers, web-enabled mobile devices etc. Standards compliance is our aim whilefollowing principles of usability and universal design, which should help all visitors of this website.', 'Guidelines for accessibility India campaign website, besides level AA of the Web Content Accessibility Guidelines (WCAG) 2.0 as laid down by the World Wide Web Consortium (W3C) are being followed. Part of the information in the website is also made available through links to external Websites. External Websites are maintained by the respective departments who are responsible for making their sites accessible.\r\n\r\nIf you have suggestions regarding the accessibility of this website, feel free to let us know the nature of the problem along with your contact information to get back to you at the earliest.'),
(2, 'Message Of The State Commissioner', 'For a Person with Disability (PwD), the Constitution of India mandated Equality of status and of opportunity enshrined under Article 14 of the Constitution of India. It becomes meaningful, only when they are able to access information/facilities. The State Commissioner for Persons with Disabilities of Telangana, made a giant leap forward, though a small step towards an “access for all” world. This website has the additional support of auditory description, scope for magnification, e-registration and tracking of complaints. Through internet connectivity we will reach out to every corner of Telangana on a 24X7 basis.', '  On behalf of all the stakeholders and on my personal behalf I am indebted to Shri K. Chandra shekhar Rao, Honourable Chief Minister of Telangana for his gesture in consenting to inaugurate the facility and have encouraged us to make Telangana a leading State in honouring the rights of PwDs in line with the RPwD Act, 2016.  The pro-active advocacy policy of the office of the State Commissioner is being pursued to its logical end. Various issues facing the PwDs are being taken up with the implementing Agencies/Departments of Government. Implementation of Government Orders, Circulars etc.by the agencies concerned is being watched and pursued.'),
(3, 'Notifications', 'add', ''),
(4, 'Success Stories', '', '');
...
CREATE TABLE `newsevents` (
  ...
  `image2` varchar(255) NOT NULL,
  `imgcontent` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `newsevents` (`aid`, `mainHeading`, `description`, `image`, `image2`, `imgcontent`) VALUES
(1, 'Distru', 'One day work shop on ï¿½World Autism Awareness dayï¿½ was held on 2nd April 2018" at National Institute for the empowerment of persons with Intellectual Disabilitiesï¿½ was organized by the Department for Welfare of Disabled and Senior Citizensï¿½, Hyderabad in collaboration with the Indian Institute of Public Health, Hyderabad (SACDIR) & National Institute for the empowerment of persons with disabilityï¿½. The supervisors from different projects, NGOï¿½s and other dignitaries were participated in the program.\r\nBefore launching the program, the rally was organized by NIEPID, and nearly 110-150 participants were participated in the rally i.e; students from NIEPID, parents, children with intellectual impairment, Anganwadi supervisors, faculties from NIEPID, faculties from IIPHH, Staff from WDC&SC etc. It was a well-received by the public with the help of placards and head caps. The rally started from NIEPID to Bowenpally vegetable market.', 'image4.jpg', '', 'After the rally the Awareness program was started by start up with the registration. The dignitary was inaugurated the workshop by lighting the lamp.'),
(2, 'hello', 'The inaugurated address was given by Dr.Uma Aysola, Deputy Director of programs from IIPHH and Major B.V. Ram Kumar, Deputy Director Administration from NIEPID has welcomed the participants. The key note address was given by Dr. Saroja Araya and she briefed about the autism and their conditions, and also given the details of different therapiesï¿½. And our chief guest Shri. Jagadeeshwar, IAS, Secretary for WDC&SC, has given the keynote address on how to detect the autism from early identification at the field level and also briefed them why they are part of the program and their role. The Director and State Commissioner for Persons with Disabilities Smt. B. Shailaja has given a key note on supervisiors roles and responsibilities at the grass root level and discussed about the referral system. The commissioner and Secretary both of them mainly focused on:\r\nï¿½ Focus on the grass root level awareness.\r\nï¿½ Early identification from the community.\r\nï¿½ Referral services for further therapies and medical treatment.\r\nAfter completion of launching, the plenary sessions was started with welcoming all the speakers on the dias', 'image5.jpg', 'image6.jpg', 'hell'),
(3, 'Distribution of Teaching and Learning Material', 'Teaching and Learning Material worth Rs.48.50 lakhs – 485 kits were distributed to special schools functioning for Intellectually disabled children across Telangana State.', '', '', ''),
(4, 'Conduct of special assessment camps for issue of disability certificates to Mentally Retarded Children', '• Special assessment camps were conducted in the campus of (15) Special Residential Schools functioning in Hyderabad and Ranga Reddy Districts for issue of disability certificates to intellectual disabled children studying in these schools\r\n• A special medical board team was constituted for this purpose for issue of disability certificates at their doorstep\r\n• 418 children with intellectual disabilities were assessed and issued disability certificates', 'image8.jpg', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `resources_data`
--

CREATE TABLE `resources_data` (
  `sid` int(255) NOT NULL,
  `Disability` varchar(255) NOT NULL,
  `Men` int(255) NOT NULL,
  `Women` int(255) NOT NULL,
  `Total` int(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `resources_data`
--

INSERT INTO `resources_data` (`sid`, `Disability`, `Men`, `Women`, `Total`) VALUES
(1, 'ghhh', 11, 23, 333),
(2, 'pgggggg', 112507, 101740, 214247),
(3, 'good', 112507, 101740, 214247),
(4, 'pgggggg', 112507, 101740, 214247),
(5, 'pgggggg', 112507, 101740, 214247),
(6, 'pgggggg', 112507, 101740, 214247),
(7, 'pgggggg', 112507, 101740, 214247),
(8, 'ddddd', 112507, 101740, 214247);

-- --------------------------------------------------------

--
-- Table structure for table `resources_text`
--
...
--
-- Dumping data for table `resources_text`
--

INSERT INTO `resources_text` (`id`, `heading`, `description`) VALUES
(1, 'Al', 'According to World Health Organization that about 15% of the world''s population lives with some form of disability, of whom 2-4% experience significant difficulties in functioning. The global disability prevalence is higher than previous WHO estimates, which date from the 1970s and suggested a figure of around 10%. This global estimate for disability is on the rise due to population ageing and the rapid spread of chronic diseases, as well as improvements in the methodologies used to measure disability.'),
(2, 'Prevalence of Disability in India ', 'According to the Census 2001, there are 2.19 million people with disabilities in India who constitute 2.13 % of the total population (Census 2001). Between the genders, the prevalence of disability was marginally higher among males than among females with a prevalence rate for males at 2% and for women 1.5% (Census 2001; NSSO 2002). According to NSSO (2002), about 8.4% and 6.1% of the total estimated households in rural and urban India, respectively, reported to have at least one disabled person. Among the rural residents, the prevalence of disability was 1.85% and that among the urban was 1.50%.'),
(3, 'National Sample Survey Organization:', '(NSSO) estimated that the number of persons with disabilities in India is 1.8% (49-90 million) of the Indian population (NSSO 2002), that 75% of persons with disabilities live in rural areas.The difference in estimates of Census (2001) and NSSO (2002) for different types of disabilities can be explained by the lack of universal definitions and criteria of disabilities used during the survey.\r\nWhy to measure?\r\nThe World Report on Disability estimates that there are about one billion people with disabilities in the world. However, there is currently little data on disability, and so this figure is very uncertain. A key reason therefore to measure disability is to estimate how many people have disabilities both globally and within different countries. This information is important for advocacy and for planning programmes.It is also important to understand the situation of people with disabilities in different settings in order to best plan services that cater to their needs and provide equality of opportunity in accordance with the UN Convention on the Rights of Persons with Disabilities (UNCRPD).\r\n'),
(4, 'Magnitude of the problem worldwide', 'People who have disability have profound difficulties in functioning and participating in their daily activities. According to the World Health Survey, approximately 785 million (15.6%) persons 15 years and older are estimated to live with a disability. These estimates are higher than World Health Organization’s (WHO) previous estimates in 1970 which was around 10%. Of these, about 110 million people (2.2%) are estimated to have very significant difficulties in functioning. The Global Burden of Disease estimates that around 975 million (19.4%) persons live with some form of disability, of which around 190 million persons (3.8%) have severe disability. These severe disability conditions include quadriplegia, severe depression, or blindness. Only the Global Burden of Disease measures childhood disabilities (0–14 years), which is estimated to be 95 million (5.1%) children, of whom 13 million (0.7%) have severe disability.'),
(5, 'Growing numbers of persons with disability\r\n', 'The number of people having different disabilities is growing because of ageing populations and the increasing chronic health conditions such as diabetes, cardiovascular diseases, and mental illness. In addition, medical advances that preserve and prolong life create overwhelming demands for health and rehabilitation services. Types of disability in a particular country are influenced by the health conditions and trends in environmental and other factors – such as road traffic crashes, natural disasters, conflict, diet, and substance abuse. Though there is an increasing prevalence of disability worldwide, adequate attention has not been given in terms of evaluation, management and prevention of disability.'),
(6, 'Prevalence of Disability in Telangana', 'According to the Census 2001, the total population of Telangana State is 3,52,86,757 in which disabled population is 10,46,822 which constitutes 2.96%.');
...
--
-- Indexes for table `resources_data`
--
ALTER TABLE `resources_data`
  ADD PRIMARY KEY (`sid`);

--
-- Indexes for table `resources_text`
--
...
--
-- AUTO_INCREMENT for table `resources_data`
--
ALTER TABLE `resources_data`
  MODIFY `sid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `resources_text`
--
ALTER TABLE `resources_text`
